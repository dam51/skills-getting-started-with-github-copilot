...
activities = {
    ...
    "Basketball Club": {
        "description": "Pickup games, drills, and intramural play for basketball enthusiasts",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and production work leading to school performances",
